...
export const metadata = {
  title: "Work | Satyam Sharma — AI Automation Engineer",
  description:
    "I build AI chatbots, voice agents, and workflow automations that run your business 24/7. From lead generation to customer support — intelligent systems that save time and scale.",
};
